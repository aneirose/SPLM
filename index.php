...
<table width="100%"  cellspacing="00" cellpadding="00">
  <tr bgcolor="grey">
    ...
    <th width="62%" scope="col"><font size="8" color="White">
      Senior Project Lifecyle Monitoring System</font></th>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><br/><br/><div style="width:50%;
    background-color:grey;
    margin-left:24%;
    margin-top:100px;border:1px solid black;">
    	<br><br>
